...
fun runApplication(conversation: UserSideConversation) =
    application(exitProcessOnExit = true) {
        Window(::exitApplication, title = "Recipe Finder") {
            FindRecipeScreen(conversation)
        }
    }
...
@Composable
private fun FindRecipeScreen(conversation: UserSideConversation) {
    val viewModel = viewModel { FindRecipeViewModel(conversation) }
