...
class InMemoryRecipeSummaryStore(
    private val storage: ConcurrentHashMap<UserId, MutableStateFlow<Map<RecipeSummaryId, ApiRecipeSummary>>> =
        ConcurrentHashMap(),
) : RecipeSummaryStore {
    ...
    private fun storedRecipeSummaries(userId: UserId): MutableStateFlow<Map<RecipeSummaryId, ApiRecipeSummary>> =
